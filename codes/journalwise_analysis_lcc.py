...
def journaltable (year):
    mapauthlist=pd.read_csv("../output/{}/{}_lcc_malf.txt".format(year,year),sep='\t')
...
for journal in list(['nature','science','cell','plos']):
    ...
    plot.figure.savefig('../output/Final_Figures/Figure4/'+str(journal)+'_lcc_barplot.svg', format='svg',dpi=1200)